...
ax.contour(X, Y, Z, colors="green", levels=levels, zorder=0)
ax.plot(1, 1, 'ro', markersize=10)

# 모멘텀 객체 생성
m = Momentum(1.5, 1.5, 0.001, 100000, 0.05, 0.8)
...
bx.plot(1, 1, 'ro', markersize=10)

# 경사하강법 객체 생성
gd = GD(1.5, 1.5, 0.001, 100000, 0.05)
